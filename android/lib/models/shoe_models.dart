...
class ShoeModel {
  ...
  static List<ShoeModel> list = [
    ...
    ShoeModel(
        ...
        decs:
            "Familiar but always Fresh, the iconic Converse is combined with Chuck Taylor for today's sneakerhead culture. This Retro High OG version goes all in with Chucks Taylors aesthtic desinging",
        price: 132,
    ...
    ShoeModel(
        name: "Nike Air Jordan 1 Retro High",
        decs:
            "Familiar but always Fresh, the iconic Air jordan 1. This Retro High OG version goes all in with full-grain leather, comfortable cushioning and classic design details.",
        price: 205,
